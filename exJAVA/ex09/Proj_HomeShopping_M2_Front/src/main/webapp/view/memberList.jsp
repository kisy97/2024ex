...
<section>
	<div class="container">
		<h1 class="title">회원 목록 조회/수정/삭제</h1>
		<table>
			<tr>
				<td>회원번호</td>
				<td>회원성명</td>
			...
			<tr>
				<td><a
					href="<%=request.getContextPath()%>/member/updateForm?custno=<%=dat.getCustno()%>">
						<%=dat.getCustno()%></a></td>
				...
				<td><%=dat.getCity()%></td>
				<td><a
					href="<%=request.getContextPath()%>/member/memberDelete?custno=<%=dat.getCustno()%>">[
						X ]</a></td>
			</tr>
			<%
			}
